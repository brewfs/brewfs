#!/usr/bin/env bash
# PR07+ local CI gate. Keep this aligned with AGENTS.md and record every
...
scratch_dir=$(mktemp -d /tmp/brewfs-pr07b-gate.XXXXXX) || exit 1
