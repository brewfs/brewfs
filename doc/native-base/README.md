...
当前验收进度（2026-09-18）：173 项矩阵中 **104 PASS**、69
`SPECIFIED_NOT_IMPLEMENTED`（提交 `e367921` 之后）。每个 PASS 都附仓库内命令、
...
RET-021/CLN-024）；GATE-002/GATE-003 的 required_features 依赖闭包仍待补。
