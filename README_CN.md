...
RustFS 是一款高性能对象存储服务，兼容 S3 协议，并与 BrewFS 在对象层落盘与工程社区上持续协同。

BrewFS 与 [RustFS 社区](https://github.com/rustfs/rustfs) 共建生态，旨在更好地服务 RustFS 等对象存储场景下的分布式数据与 POSIX 语义交付。
